...
//    self.CardTimeLabel.textColor = [UIColor colorFromHex:@"#999999"];
    ...
    self.CardTimeLabel.textColor = [UIColor colorFromHex:@"#999999"];
    self.CardnameLabel.textColor = [UIColor colorFromHex:@"#999999"];
    self.CardTimeLabel.font = [UIFont systemFontOfSize:13*Main_Screen_Height/667];
    self.CardnameLabel.font = [UIFont boldSystemFontOfSize:18*Main_Screen_Height/667];
    self.CardnameLabel.textColor    = [UIColor colorFromHex:@"4a4a4a"];
    
    self.jinding.left   = self.CardnameLabel.right;
    self.jinding.bottom = self.CardnameLabel.bottom;
    
    [self.CardTimeLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.backgroundImgV).mas_offset(25*Main_Screen_Height/667);
